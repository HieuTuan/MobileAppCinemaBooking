...
class RegisterRequest {
  ...
  /// Validates phone number format (0 + 9 digits or +84 + 9 digits)
  String? validatePhone() {
    // Pattern: starts with 0 followed by exactly 9 digits (total 10), OR starts with +84 followed by exactly 9 digits
    final phoneRegex = RegExp(r'^(0[0-9]{9}|\+84[0-9]{9})$');
    
    if (!phoneRegex.hasMatch(phone)) {
      return 'Please enter a valid phone number (format: 0XXXXXXXXX or +84XXXXXXXXX)';
    }
