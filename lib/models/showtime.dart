...
class Showtime {
  ...
  /// VIP seat ticket price in VND
  final int vipSeatPrice;

  /// Couple seat ticket price in VND
  final int coupleSeatPrice;

  /// Showtime status (scheduled, cancelled, completed)
  final String status;
  ...
  /// Checks if showtime is closed/completed.
  ...
  String get formattedPrice {
    return '${basePrice.toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')} VND';
  }
